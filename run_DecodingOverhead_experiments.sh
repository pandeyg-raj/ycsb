...
mkdir -p result_DecodingOverhead_Mix
OUT_DIR=result_DecodingOverhead_Mix
...
for i in "${!WORKLOAD_LABELS[@]}"; do
  ...
  mkdir -p result_DecodingOverhead_NoDecode
  OUT_DIR=result_DecodingOverhead_NoDecode
  read -p "Kill a Parity node5 and Press Enter to continue..."
  ...
  mkdir -p result_DecodingOverhead_ALLDecode
  OUT_DIR=result_DecodingOverhead_ALLDecode
  read -p "Start parity node5 and Kill a Data node3 and Press Enter to continue..."
