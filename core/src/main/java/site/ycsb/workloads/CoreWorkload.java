...
public class CoreWorkload extends Workload {
  ...
  public void init(Properties p) throws WorkloadException {
    ...
    if (dataintegrity) {
      ...
      System.out.println("Data integrity is not enabled.");
    }
  ...
  protected void verifyRow(String key, HashMap<String, ByteIterator> cells) {
    ...
    if (!cells.isEmpty()) {
      for (Map.Entry<String, ByteIterator> entry : cells.entrySet()) {
        String expectedVal = buildDeterministicValue(key, entry.getKey());
        String gotVal = entry.getValue().toString();
        //System.out.println("\nkey "+key+ " expected value:"+ expectedVal);
        ...
        if(isEC && entry.getKey().equals(ECCOLUMN)){
          ...
          isequal = gotVal.equals(expectedVal);
        } 
