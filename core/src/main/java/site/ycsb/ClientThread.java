...
public class ClientThread implements Runnable {
  ...
  public void run() {
    ...
    try {
      //double lambda = Double.parseDouble(props.getProperty("poisson_lambda","1.0"));
      //System.out.println("lambda," + lambda);
      //PoissonArrivalGenerator generator = new PoissonArrivalGenerator(lambda);
      if (dotransactions) {
        ...
        opsdone++;
        //generator.sleepUntilNextArrival();
        ...
        //System.out.println("RequestStart," + System.nanoTime());
