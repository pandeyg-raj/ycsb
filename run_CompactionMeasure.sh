...
WORKLOAD_LABELS=("read5")
READ_PROPORTIONS=("readproportion=0.05 -p insertproportion=0.95")
...
mkdir -p Compaction_Measure_10KB

OUT_DIR=Compaction_Measure_10KB
...
breakdownresult="Compaction_Measure_10KB_${EXP_LABEL}_summary.txt"
...
echo "Script will sleep for 5 minutes now."
sleep 5m
